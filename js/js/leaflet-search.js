...
!function(a) {
    ...
    return a.Control.Search = a.Control.extend({
        ...
        addTo: function(b) {
            return this.options.container ? (this._container = this.onAdd(b),
            this._wrapper = a.DomUtil.get(this.options.container),
            this._wrapper.style.position = "relative",
            this._wrapper.appendChild(this._container)) : a.Control.prototype.addTo.call(this, b),
            this
        },
        onRemove: function(a) {
            this._recordsCache = {}
        ...
        collapse: function() {
            ...
            this._input.blur(),
            this.options.collapsed && (this._input.style.display = "none",
            this._cancel.style.display = "none",
        ...
        _createTip: function(b, c) {
            ...
            if (this.options.buildTip) {
                if (d = this.options.buildTip.call(this, b, c),
                "string" == typeof d) {
        ...
        showTooltip: function(a) {
            ...
            return this._countertips > 0 ? (this._tooltip.style.display = "block",
            this._autoTypeTmp && this._autoType(),
            this._autoTypeTmp = this.options.autoType) : this._hideTooltip(),
                ...
                if (!f.hasOwnProperty("_isMarkerSearch"))
                    if (f instanceof a.Marker || f instanceof a.CircleMarker)
                        try {
                            ...
                            console.log ("I am using line 377")
                        }
                        ...
                        try {
                            ...
                            console.log ("I am using line 387")
                        } catch (g) {
                            console.log ("I am using line 388")
                        }
                    else
                        f instanceof a.LayerGroup && f.eachLayer(function(a) {
                            try {
                              ...
                              console.log("I am using line 390")
                            }
                            catch {
                              console.log("I am using line 391")
                              c = f.getBounds().getCenter()
                              c.layer = a,
                              d[a.feature.properties[e]] = c
                            }
        ...
        _autoType: function() {
            ...
            if (0 === b.indexOf(this._input.value))
                ...
                this._input.createTextRange) {
                    ...
                    this._input.setSelectionRange ? this._input.setSelectionRange(a, c) : this._input.selectionStart && (this._input.selectionStart = a,
        ...
        _handleKeypress: function(a) {
            ...
            case 27:
                ...
                break;
            case 13:
                (1 == this._countertips || this.options.firstTipSubmit && this._countertips > 0) && this._handleArrowSelect(1),
                this._handleSubmit();
                break;
            case 38:
            ...
            case 36:
                break;
            default:
                if (this._input.value.length ? this._cancel.style.display = "block" : this._cancel.style.display = "none",
        ...
        _fillRecordsCache: function() {
            ...
            this.showTooltip(b),
            a.DomUtil.removeClass(this._container, "search-load")) : (this.options.sourceData ? this._retrieveData = this.options.sourceData : this.options.url && (this._retrieveData = this.options.jsonpParam ? this._recordsFromJsonp : this._recordsFromAjax),
            this._curReq = this._retrieveData.call(this, c, function(c) {
                d._recordsCache = d._formatData(c),
                b = d.options.sourceData ? d._filterData(d._input.value, d._recordsCache) : d._recordsCache,
                d.showTooltip(b),
    ...
    a.Control.Search.Marker = a.Marker.extend({
        ...
        onAdd: function(b) {
            ...
            this._circleLoc && (b.addLayer(this._circleLoc),
    ...
    a.Map.addInitHook(function() {
        this.options.searchControl && (this.searchControl = a.control.search(this.options.searchControl),
