  ...
  for (var i = 0; i < milanoSites.length; i++) {
    ...
    result.features.push({
      ...
      properties: {
        ...
        fonti: (s.fonti !== undefined ? s.fonti : (s.fonte !== undefined ? s.fonte : '')),
        sources: (s.sources !== undefined ? s.sources : (s.source !== undefined ? s.source : '')),
        fonte: (s.fonte !== undefined ? s.fonte : (s.fonti !== undefined ? s.fonti : '')),
        source: (s.source !== undefined ? s.source : (s.sources !== undefined ? s.sources : ''))
      }
    });
  }
